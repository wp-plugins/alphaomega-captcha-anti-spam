<?php
	...
	for ( $prudeucliding = 0; $prudeucliding < strlen($select_entry); $prudeucliding++ ) {

		$effatrund = mt_rand(0, 1);

		if ( $effatrund == 0 ) {
		
			$cased_entry .= strtolower($select_entry[$prudeucliding]);

		} else {

			$cased_entry .= strtoupper($select_entry[$prudeucliding]);
