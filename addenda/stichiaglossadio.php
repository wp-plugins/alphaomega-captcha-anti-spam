...
$stichiatitle = 'AlphaOmega Captcha & Anti-Spam 設定';
$predonate = '<span style="color:#000080;">AlphaOmega Captcha & Anti-Spam</span> 効果的であり、ユーザー コメント不適切なコンテンツを簡単に使用できるキャプチャとスパム（迷惑メール）・ フィルターをブロックするスパム対策のプラグイン。このプラグインは、管理ログでページの自動攻撃も阻止できます。<div style="padding-top:10px;">以下に示す既定の設定は高レベルのスパムや悪意のある管理者ログイン ページの攻撃に対する保護を提供します。また、追加のカスタマイズされたプラグインの動作をする場合の既定の設定を調整するオプションがあります。';
$donatetitle = '寄付をご検討下さい';
$donateshpeel = '任意の方法で便利な場合は、この無料のプラグインの開発継続をサポートするために小額の寄付を提供することを検討する場合 <span style="color:#000080;">AlphaOmega Captcha & Anti-Spam</span> クリエイター非常に感謝しました。任意寄付金額を謙虚に高く評価されます。ありがとう。';
$donateinput = '<input type="hidden" name="country" value="JP" ><input type="hidden" name="item_name" value="AlphaOmega Captcha & Anti-Spamの寄付"><input type="hidden" name="currency_code" value="JPY">';
...
$stepcaptypetria = '首都または地理的な場所の名前を入力する必要があります。';
$stepcaptypetesera = '科学的な質問やクイズに答える必要があります。';
$stepcaptypepente = '有名な映画のタイトルを入力する必要があります。';
$stepcaptypeexi = '有名な歴史上の人物の名前を入力する必要があります。';
$stepcaptypeefta = 'ユーザーを共通のコンピューターの頭字語で表される単語を入力する必要があります。';
...
$stepfeedbackpostshpeel = '<strong>AlphaOmega Captcha & Anti-Spam</strong>を使用していただきありがとうございます。';
