...
$stichiatitle = 'AlphaOmega Captcha & Anti-Spam Settings';
$predonate = 'The <span style="color:#000080;">AlphaOmega Captcha & Anti-Spam</span> plugin is an effective and simple-to-use captcha and anti-spam plugin that blocks spam and filters posted user comments for inappropriate content. This plugin can also thwart automated attacks against your Admin Log In page.<div style="padding-top:10px;">The default settings shown below provide a high level of protection against spam and malicious Admin Log In page attacks. You also have the option of adjusting the default settings if you want additional customized plugin behavior.';
$donatetitle = 'Please Consider Donating';
$donateshpeel = 'The creators of the <span style="color:#000080;">AlphaOmega Captcha & Anti-Spam</span> plugin would appreciate it very much if you would consider providing a small donation to help support the continued development of this free plugin if you find it useful in any way. Any donation amount will be humbly appreciated. Thank you.';
$donateinput = '<input type="hidden" name="country" value="US" ><input type="hidden" name="item_name" value="Donation for AlphaOmega Captcha & Anti-Spam Plugin"><input type="hidden" name="currency_code" value="USD">';
...
$stepcaptypetria = 'A modification of the traditional captcha that requires the user to enter the name of a capital city or geographical place.';
$stepcaptypetesera = 'A mutation of the ubiquitous captcha that requires the user to enter an answer to a scientific question or quiz.';
$stepcaptypepente = 'A variant of the customary captcha that requires the user to enter the title of a well-known film.';
$stepcaptypeexi = 'An alteration of the familiar captcha that requires the user to enter the name of a famous historical figure.';
$stepcaptypeefta = 'An instantiation of a captcha that requires the user to enter the words represented by a common computer acronym.';
...
$stepfilterpreshpeel = 'The standard Wordpress Comment Form contains several form elements such as Name, E-mail, URL, and Comment or Message.<p>If any of these form elements are present in your comment form, this plugin setting allows you to select the elements whose content you wish to check or filter for possible spam. Comment submissions containing spam-related keywords or phrases (configured below in the <span style="letter-spacing:1.2px;color:#000080;">Spam Filter List</span>) will be blocked, and not sent to you.</p><p>This can be a very effective way to thwart relentless automated and manual spam attacks, and therefore free your Wordpress Admin area from being inundated with unwanted and annoying spam-related comments.</p>';
...
$stepfeedbackpostshpeel = 'Thank you for using the <strong>AlphaOmega Captcha & Anti-Spam</strong> plugin.';
