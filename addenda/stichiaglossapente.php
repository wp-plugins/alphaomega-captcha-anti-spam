...
$stichiatitle = 'AlphaOmega Captcha & Anti-Spam 設置';
$predonate = '<span style="color:#000080;">AlphaOmega Captcha & Anti-Spam</span> 是一個有效的和使用簡單的驗證碼和阻止垃圾郵件和篩選器的反垃圾郵件外掛程式發佈不良內容的使用者注釋。此外掛程式還可以阻礙您管理日誌中的頁面自動的攻擊。<div style="padding-top:10px;">如下所示的預設設置為提供高級別保護免受垃圾郵件和惡意管理員登錄頁面的攻擊。您還可以調整預設的設置，如果您想附加自訂的外掛程式行為的選項。';
$donatetitle = '請考慮捐贈';
$donateshpeel = '<span style="color:#000080;">AlphaOmega Captcha & Anti-Spam</span> 的建立者將會非常感激如果你會考慮提供小小的捐贈，以説明支援這個免費的外掛程式的持續的發展，如果您發現它以任何方式很有用。任何捐款金額將謙遜地表示讚賞。謝謝。';
$donateinput = '<input type="hidden" name="item_name" value="AlphaOmega Captcha & Anti-Spam捐贈"><input type="hidden" name="currency_code" value="USD">';
$donatekubitext = '請捐贈';
...
$stepcaptypetria = '要求使用者輸入一個省會城市或地理位置的名稱。';
$stepcaptypetesera = '要求使用者輸入一個科學問題或測驗的答案。';
$stepcaptypepente = '要求使用者輸入標題的一部著名的電影。';
$stepcaptypeexi = '要求使用者輸入一個著名的歷史人物的名稱。';
$stepcaptypeefta = '要求使用者輸入由常見電腦首字母縮寫詞的詞。';
...
$stepfeedbackpostshpeel = '感謝您使用 <strong>AlphaOmega Captcha & Anti-Spam</strong>。';
