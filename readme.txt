...
1. Install automatically by first clicking the WordPress 'Plugins' > 'Add New' menu item. The 'Plugins' and 'Add New' menu items are located on the left column of the WordPress Dashboard. Then type 'AlphaOmega Captcha Anti-Spam Filter' as a search, and select to install the AlphaOmega Captcha & Anti-Spam Filter plugin. Alternatively, you can manually download the 'alphaomega-captcha-anti-spam.zip' file from the [AlphaOmega Captcha & Anti-Spam Filter WordPress site](http://wordpress.org/extend/plugins/alphaomega-captcha-anti-spam/) - the download link is the red button located at approximately one o'clock on the WordPress AlphaOmega Captcha & Anti-Spam Filter plugin site, with the text '**Download Version x.y**' printed on the button, where **x.y** refers to the latest plugin version number. Unpack the downloaded zip file, and install the plugin manually by uploading the 'alphaomega-captcha-anti-spam' folder into the '/wp-content/plugins/' directory.
